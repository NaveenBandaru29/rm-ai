...
export const FAQ = () => {
  ...
  return (
    <Box sx={{ pt: { xs: 12, sm: 16 }, pb: { xs: 8, sm: 12 }, minHeight: '80vh', bgcolor: '#f8fafc', px: { xs: 2, sm: 0 } }}>
      <Helmet>
        <title>FAQ • RM AI</title>
        <meta name="description" content="Answers to common questions about RM AI courses, certificates, refunds, and access. Everything you need to know before enrolling." />
      </Helmet>
